...
var assocs = [{
	...
	},
	{
		_id: 6,
		nome: "Uelpa",
		endereco: "Rua Azevedo Sodré, 156 sala 64",
		telefone: "(13) 3286-1621",
		email: "fabio@uelpa.com.br",
		site: "http://www.uelpa.com.br/",
		linhas: []
	}];
...
exports.getLinhas = function(idAssoc, fn) {
	switch(idAssoc) {
		...
		case "6":
			return require('./FretadoApp.API.Associacoes.Uelpa').getLinhas(assocs[5], fn);
		default:
			fn();
	}
}